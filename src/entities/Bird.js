(function (Core) {
    ...
    var Bird = Core.Entity.extend({
        ...
        font: new Core.Font("res/flapfont.png", 16, 22, "abcdefghijklmnopqrstuvwxyz"),
        font2: new Core.Font("res/flapfont2.png", 16, 22, "abcdefghijklmnopqrstuvwxyz"),
        ...
        tick: function () {
            ...
            switch (this.state.get()) {
                ...
                case "RUNNING":
                    ...
                    if (this.y > Core.env.h - 112 - this.h) {
                        this.y = oldy;
                        this.die();
                    }
                    break;
        ...
        handleKeys: function () {
            if (Core.input.lastKey) {
                if (String.fromCharCode(Core.input.lastKey).toLowerCase() === 'p') {
                    a = a;
                }
                else {
                    this.ac = this.jumpAc;
                ...
                /*
                if (String.fromCharCode(Core.input.lastKey).toLowerCase() === this.curWord[this.curIdx]){
                    this.ac = jumpAc;
                    this.curIdx++;
        ...
        render: function (gfx) {
            ...
            window.game.atlas.render(
                gfx,
                "bird" + this.color + "_" + Core.utils.toggle(this.flapping, 3),
                this.x - 11,
                this.y - 17);
